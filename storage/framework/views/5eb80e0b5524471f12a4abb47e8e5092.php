    ...
    <!-- Enhanced Tab Content -->
        <div class="bg-white shadow-sm">
            ...
            <table class="min-w-full table-auto">
                ...
                <tbody>
                    <?php $__empty_2 = true; $__currentLoopData = $submissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-center text-sm text-gray-700">
                                <div class="flex justify-center p-2">
                                    <a href="<?php echo e(route('reviewer.abstract.assessment', ['serial_number' => $submission->serial_number])); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition-all">
        ...
        <table class="min-w-full table-auto">
            ...
            <tbody>
                <?php $__empty_2 = true; $__currentLoopData = $researchSubmissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $researchSubmission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                    <tr class="border-b hover:bg-gray-50">
                        <td class="px-4 py-3 text-center">
                            <input type="checkbox" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                        </td>
