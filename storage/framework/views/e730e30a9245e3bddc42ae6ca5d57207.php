                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" 
                            ...
                            <div class="hidden md:block text-left">
                                <div class="text-sm font-semibold text-white group-hover:text-gray-800"><?php echo e($user->salutation .  ' ' . $user->first_name); ?></div>
        ...
        <aside x-cloak
            ...
            <nav class="mt-16 lg:mt-4 p-4 space-y-4">
                ...
                <div class="space-y-2">
                    ...
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center text-gray-800 hover:bg-gray-200 hover:text-gray-900 rounded-md px-3 py-2 transition-colors duration-200">
                        <svg class="w-5 h-5 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                        </svg>
                        Dashboard
                    </a>
                    <a href="<?php echo e(route('admin.abstracts')); ?>" class="flex items-center text-gray-800 hover:bg-gray-200 hover:text-gray-900 rounded-md px-3 py-2 transition-colors duration-200">
                        <svg class="w-5 h-5 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                        Conference Papers
                    </a>
                    <a href="<?php echo e(route('admin.proposals')); ?>" class="flex items-center text-gray-800 hover:bg-gray-200 hover:text-gray-900 rounded-md px-3 py-2 transition-colors duration-200">
                        <svg class="w-5 h-5 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                        </svg>
                        Proposal Papers
                    </a>
                    <a href="<?php echo e(route('admin.reports')); ?>" class="flex items-center text-gray-800 hover:bg-gray-200 hover:text-gray-900 rounded-md px-3 py-2 transition-colors duration-200">
                        <svg class="w-5 h-5 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                        </svg>
                        Completed
                    </a>
                    <a href="<?php echo e(route('admin.users')); ?>" class="flex items-center text-gray-800 hover:bg-gray-200 hover:text-gray-900 rounded-md px-3 py-2 transition-colors duration-200">
                        <svg class="w-5 h-5 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="<?php echo e(route('submission-types.index')); ?>" class="flex items-center text-gray-800 hover:bg-gray-200 hover:text-gray-900 rounded-md px-3 py-2 transition-colors duration-200">
                        <svg class="w-5 h-5 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                        </svg>
                        Submission Types
                                        ...
                                        <?php $__currentLoopData = auth()->user()->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <button 
                                                ...
                                                class="w-full text-left px-3 py-2 hover:bg-gray-100 rounded-md 
                                                    <?php echo e(session('current_role') == $role->name ? 'bg-blue-50 text-blue-700' : 'text-gray-700'); ?>" 
                                            >
                ...
                <div class="space-y-2">
                    ...
                    <!-- Enhanced Navigation Items with Icons -->
                    <a href="<?php echo e(route('reviewer.dashboard')); ?>" class="flex items-center text-gray-800 hover:bg-gray-200 hover:text-gray-900 rounded-md px-3 py-2 transition-colors duration-200">
                        <svg class="w-5 h-5 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                        </svg>
                        Dashboard
                    </a>
                    <a href="<?php echo e(route('reviewer.documents')); ?>" class="flex items-center text-gray-800 hover:bg-gray-200 hover:text-gray-900 rounded-md px-3 py-2 transition-colors duration-200">
                        <svg class="w-5 h-5 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="<?php echo e(route('reviewer.reviewed')); ?>" class="flex items-center text-gray-800 hover:bg-gray-200 hover:text-gray-900 rounded-md px-3 py-2 transition-colors duration-200">
                        <svg class="w-5 h-5 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                        </svg>
                        Reviewed
                    </a>
                    <a href="<?php echo e(route('reviewer.profile')); ?>" class="flex items-center text-gray-800 hover:bg-gray-200 hover:text-gray-900 rounded-md px-3 py-2 transition-colors duration-200">
                        <svg class="w-5 h-5 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                        Profile
                ...
                <div class="space-y-2">
                    ...
                    <!-- Enhanced Navigation Items with Icons -->
                    <a href="<?php echo e(route('user.dashboard')); ?>" class="flex items-center text-gray-800 hover:bg-gray-200 hover:text-gray-900 rounded-md px-3 py-2 transition-colors duration-200">
                        <svg class="w-5 h-5 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                        </svg>
                        Dashboard
                    </a>
                    <a href="<?php echo e(route('user.submit')); ?>" class="flex items-center text-gray-800 hover:bg-gray-200 hover:text-gray-900 rounded-md px-3 py-2 transition-colors duration-200">
                        <svg class="w-5 h-5 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                        </svg>
                        Submit
                    </a>
                    <a href="<?php echo e(route('user.documents')); ?>" class="flex items-center text-gray-800 hover:bg-gray-200 hover:text-gray-900 rounded-md px-3 py-2 transition-colors duration-200">
                        <svg class="w-5 h-5 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                        Submissions
                    </a>
                    <a href="<?php echo e(route('user.drafts')); ?>" class="flex items-center text-gray-800 hover:bg-gray-200 hover:text-gray-900 rounded-md px-3 py-2 transition-colors duration-200">
                    ...
                    <a href="<?php echo e(route('user.profile')); ?>" class="flex items-center text-gray-800 hover:bg-gray-200 hover:text-gray-900 rounded-md px-3 py-2 transition-colors duration-200">
                        <svg class="w-5 h-5 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                        Profile
