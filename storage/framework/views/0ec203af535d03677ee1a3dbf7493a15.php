        ...
        <form id="previewForm" action="<?php echo e(route('submit.preview')); ?>" method="POST">
            ...
            <div class="bg-gray-50 p-6 border border-gray-800">
                ...
                <div class="p-8">
                    ...
                    <p class="text-gray-700 leading-relaxed"><?php echo e(isset($abstract['keywords']) ? implode(', ', $abstract['keywords']) : 'No keywords provided.'); ?></p>
                </div>

                <!-- Sub-Theme Section -->
                <div class="p-8">
                    <h2 class="text-xl font-bold text-gray-900 mb-2">Sub-Theme</h2>
                    <p class="text-gray-700 leading-relaxed"><?php echo e($abstract['sub_theme'] ?? 'No sub-theme selected.'); ?></p>
                </div>
            </div>
...
<?php echo $__env->make('user.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MSS\email-verification-app\resources\views\user\partials\preview.blade.php ENDPATH**/ ?>