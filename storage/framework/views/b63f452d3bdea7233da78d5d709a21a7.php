    ...
    <div class="flex w-full h-full">
        ...
        <div class="w-full md:w-3/2 bg-gray-100 flex items-center justify-center p-8">
            <div class="w-full max-w-md">
                <form method="POST" action="<?php echo e(route('login')); ?>" class="bg-gray-100 px-10 pt-8 pb-10">
                <?php echo csrf_field(); ?>
                    <div class="mb-8">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        <input 
                        type="password" 
                        class="password-input form-control <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div>
                            <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-indigo-600 hover:text-indigo-500 custom-link">
                                Forgot password?
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="text-center mt-6">
                        <p class="text-sm text-gray-600">
                            ...
                            <a href="<?php echo e(route('register')); ?>" class="font-medium text-indigo-600 hover:text-indigo-500 custom-link">
                                Create an account
                            </a>
                        </p>
                    </div>
...
<?php /**PATH D:\MSS\mss-project\resources\views/auth/login.blade.php ENDPATH**/ ?>