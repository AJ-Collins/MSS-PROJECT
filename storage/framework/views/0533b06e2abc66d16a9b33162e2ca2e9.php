    ...
    <div class="py-8">
        <div class="sm:flex sm:items-center mb-6">
            <div class="sm:flex-auto">
                <h2 class="text-xl font-semibold text-gray-900"><?php echo e(ucfirst($type)); ?> Drafts</h2>
                <p class="mt-2 text-sm text-gray-700">
                    Below is the list of all your <?php echo e($type); ?> drafts. You can continue working on them or delete the ones you no longer need.
                </p>
            </div>
        </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-300">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php if($type === 'proposal'): ?>
                                    <?php $__empty_1 = true; $__currentLoopData = $proposalDrafts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $draft): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-gray-900"><?php echo e($draft->title ?? 'Untitled Draft'); ?></div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                <?php echo e(\Carbon\Carbon::parse($draft->created_at)->format('d M Y')); ?>

                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                <?php echo e(\Carbon\Carbon::parse($draft->updated_at)->format('d M Y')); ?>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <a href="<?php echo e(route('user.resume.proposal.draft', ['serialNumber' => $draft->serial_number])); ?>" 
                                                   class="text-indigo-600 hover:text-indigo-900 mr-3 transition duration-200 ease-in-out">Continue submission</a>
                                                <button onclick="deleteDraft('<?php echo e($draft->serial_number); ?>', 'proposals')" 
                                    ...
                                    <?php endif; ?>
                                <?php elseif($type === 'abstract'): ?>
                                    <?php $__empty_1 = true; $__currentLoopData = $abstractDrafts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $draft): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-gray-900"><?php echo e($draft->title ?? 'Untitled Draft'); ?></div>
                                            </td>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <a href="<?php echo e(route('user.resume-draft', ['serialNumber' => $draft->serial_number])); ?>" 
                                                   class="text-indigo-600 hover:text-indigo-900 mr-3 transition duration-200 ease-in-out">Continue submission</a>
                                                <button onclick="deleteDraft('<?php echo e($draft->serial_number); ?>', 'abstracts')" 
                                                        class="text-red-600 hover:text-red-900 transition duration-200 ease-in-out">Delete</button>
                                            </td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
async function deleteDraft(serialNumber, draftType) {
    try {
        ...
        const url = draftType === 'proposals' 
            ? `<?php echo e(url('/user/proposal-drafts/delete')); ?>/${serialNumber}`
            : `<?php echo e(url('/user/drafts/delete')); ?>/${serialNumber}`;
...
<?php echo $__env->make('user.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MSS\email-verification-app\resources\views/user/partials/drafts.blade.php ENDPATH**/ ?>