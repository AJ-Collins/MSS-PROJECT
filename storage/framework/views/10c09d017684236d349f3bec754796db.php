                            ...
                            <td class="px-4 py-3 text-sm text-gray-700">
                                ...
                                <td class="px-4 py-3">
                                    <div x-data="{ isOpen: false }" class="flex justify-center space-x-1.5">
                                        <form action="<?php echo e(route('approve.abstract')); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                        ...
                        <?php $__currentLoopData = $researchSubmissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $researchSubmission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <td class="px-4 py-3 text-sm text-gray-700">
                                ...
                                <div x-data="{ isOpen: false, isRejectModalOpen: false }" class="flex justify-center space-x-1.5">
                                    <form action="<?php echo e(route('approve.proposal')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MSS\mss-main\resources\views/admin/partials/dashboard.blade.php ENDPATH**/ ?>