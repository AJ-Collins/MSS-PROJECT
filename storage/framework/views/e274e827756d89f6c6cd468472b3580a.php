...
<div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
    <!-- Back Button -->
    <div class="mb-6">
        <a href="<?php echo e(route('admin.proposals')); ?>" class="inline-flex items-center text-sm font-medium text-indigo-600 hover:text-indigo-500">
    ...
    <div class="bg-white shadow overflow-hidden mb-6">
        <div class="px-4 py-5 sm:px-6">
            <div class="flex justify-between items-start">
                <div>
                    <h3 class="text-lg leading-6 font-medium text-gray-900"><?php echo e($researchSubmission->article_title); ?></h3>
                    <p class="mt-1 max-w-2xl text-sm text-gray-500">Serial Number: <?php echo e($researchSubmission->serial_number); ?></p>
                </div>
                <span class="px-4 py-2 rounded-full text-sm font-semibold <?php echo e($researchSubmission->score === null ? 'bg-yellow-300 text-gray-800' :
                    ($researchSubmission->score ? 'bg-green-300 text-gray-800' : 'bg-gray-300 text-gray-800')); ?>">
                    <?php echo e($researchSubmission->score === null ? 'Pending' : 
        ...
        <div class="border-t border-gray-200">
            <dl>
                <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2"><?php echo e($researchSubmission->user_reg_no); ?></dd>
                </div>
                <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    <dt class="text-sm font-medium text-gray-500">Submission Date</dt>
                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                        <?php echo e(date('F j, Y', strtotime($researchSubmission->created_at))); ?>
    ...
    <div class="bg-white shadow overflow-hidden mb-6">
        ...
        <ul class="divide-y divide-gray-200">
                <?php $__empty_1 = true; $__currentLoopData = $researchSubmission->reviewers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reviewer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <li class="px-4 py-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-900"><?php echo e($researchSubmission->first_name); ?> <?php echo e($reviewer->last_name); ?></p>
                        ...
                        <?php if($assessment && $assessment->total_score): ?> <!-- Check if total_score exists for the specific assessment -->
                            <a href="<?php echo e(route('proposalAssessment.download.anyone', ['serial_number' => $researchSubmission->serial_number, 'reviewer_reg_no' => $reviewer->reg_no])); ?>" 
    ...
    <div class="p-4 sm:p-6">
        <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 items-start">
            ...
            <div class="flex space-x-4 w-full sm:w-auto">
                <form action="<?php echo e(route('unapprove.proposal', ['serial_number' => $researchSubmission->serial_number])); ?>" method="POST" class="w-full sm:w-auto">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MSS\mss-project\resources\views/admin/partials/proposal_details.blade.php ENDPATH**/ ?>