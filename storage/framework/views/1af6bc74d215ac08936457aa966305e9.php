                ...
                <div class="bg-gray-50 p-4 sm:p-6 border border-gray-800">
                    ...
                    <div class="text-base sm:text-lg font-medium text-gray-700 text-center mt-2 break-words">
                        <?php if(isset($allAuthors) && is_array($allAuthors)): ?>
                            <?php $__currentLoopData = $allAuthors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $author): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if(isset($allAuthors) && is_array($allAuthors)): ?>
                            <?php $__currentLoopData = $allAuthors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $author): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="w-full text-center" style="text-indent: 2em;">
                                    <sup><?php echo e($index + 1); ?></sup> <?php echo e($author['university']); ?>, <?php echo e($author['department']); ?>
