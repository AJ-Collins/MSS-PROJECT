                            ...
                            <?php $__currentLoopData = $submissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50 transition duration-150">
                                        <td class="px-4 py-3 text-sm text-gray-700">
                                            <div class="font-medium"><?php echo e($submission->article_title); ?></div>
                                            <div class="text-xs text-gray-500"><?php echo e($submission->serial_number); ?></div>
                                        </td>
                                        <td class="px-4 py-3 text-sm text-gray-700">
                                            <div class="font-medium"><?php echo e($submission->user->name); ?></div>
                                        ...
                                        <td class="px-6 py-4">
                                            <?php if($submission->reviewer): ?>
                                                <div class="font-medium"><?php echo e($submission->reviewer->name); ?></div>
                        ...
                        <table class="w-full">
                            ...
                            <?php $__currentLoopData = $researchSubmissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $researchSubmission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50 transition duration-150">
                                        ...
                                        <td class="px-4 py-3 text-sm text-gray-700">
                                            <div class="font-medium"><?php echo e($researchSubmission->user->name); ?></div>
                                        ...
                                        <td class="px-6 py-4">
                                            <?php if($researchSubmission->reviewer): ?>
                                                <div class="font-medium"><?php echo e($researchSubmission->reviewer->name); ?></div>
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MSS\email-verification-app\resources\views/admin/partials/reports.blade.php ENDPATH**/ ?>