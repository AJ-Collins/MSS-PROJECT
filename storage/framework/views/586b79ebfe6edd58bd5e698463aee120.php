            ...
            <div class="flex flex-wrap gap-3">
                <div class="space-y-2">
                    ...
                    <div class="flex gap-2">
                        <a href="<?php echo e(route('abstract.downloadAll')); ?>" 
                        ...
                        <a href="<?php echo e(route('abstracts.download.word')); ?>" 
                        class="px-3 py-2 bg-white text-blue-700 rounded-lg hover:bg-blue-50 transition duration-200 flex items-center gap-2 border border-blue-200 shadow-sm">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex gap-2">
                        <a href="<?php echo e(route('proposal.downloadAll')); ?>" 
                        class="px-3 py-2 bg-white text-blue-700 rounded-lg hover:bg-blue-50 transition duration-200 flex items-center gap-2 border border-blue-200 shadow-sm">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l3 3m0 0l3-3m-3 3V10"/>
                            </svg>
                        ...
                        <a href="<?php echo e(route('proposal.downloadAllWord')); ?>" 
                        class="px-3 py-2 bg-white text-blue-700 rounded-lg hover:bg-blue-50 transition duration-200 flex items-center gap-2 border border-blue-200 shadow-sm">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                            </svg>
