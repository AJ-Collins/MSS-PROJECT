                                        ...
                                        <div class="p-4 sm:p-8">
                                            ...
                                            <div class="text-base sm:text-lg font-medium text-gray-700 text-center mt-2 break-words">
                                                <?php if(isset($authorData) && is_array($authorData)): ?>
                                                    <?php $__currentLoopData = $authorData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $author): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php echo e($author['first_name']); ?> <?php echo e($author['middle_name'] ?? ''); ?> <?php echo e($author['surname']); ?>

                                                        <sup><?php echo e($index + 1); ?><?php echo e(isset($author['is_correspondent']) && $author['is_correspondent'] ? '*' : ''); ?></sup>
                                                ...
                                                <?php if(isset($authorData) && is_array($authorData)): ?>
                                                    <?php $__currentLoopData = $authorData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $author): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="w-full text-center" style="text-indent: 2em;">
                                                            <sup><?php echo e($index + 1); ?></sup> <?php echo e($author['university']); ?>
                                            ...
                                            <div class="flex flex-col items-center text-sm sm:text-base text-gray-600 mt-2 space-y-1">
                                                <?php if(isset($authorData) && is_array($authorData)): ?>
                                                    <?php $__currentLoopData = $authorData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $author): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="w-full text-center" style="text-indent: 2em;">
                                                            <sup><?php echo e($index + 1); ?></sup> <?php echo e($author['department']); ?>
                                            ...
                                            <div class="text-sm sm:text-base text-gray-600 text-center mt-2 italic break-words">
                                                <?php if(isset($authorData) && is_array($authorData)): ?>
                                                    * Correspondence: 
                                                    <?php $__currentLoopData = $authorData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $author): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if(isset($author['is_correspondent']) && $author['is_correspondent']): ?>
                                                            <?php echo e($author['email'] ?? ''); ?><?php if(!$loop->last): ?>; <?php endif; ?>
                                                        <?php endif; ?>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                                            </div>
