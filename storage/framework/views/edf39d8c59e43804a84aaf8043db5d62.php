                ...
                <div class="w-full lg:w-1/2 p-6 border border-gray-800 flex flex-col h-full">
                    ...
                    <?php if($documentPath): ?>
                        <?php if(pathinfo($documentPath, PATHINFO_EXTENSION) === 'pdf'): ?>
                            <embed src="<?php echo e(asset('storage/research_proposals/' . basename($documentPath))); ?>" type="application/pdf" class="w-full h-full rounded-lg" style="min-height: 800px;">                            
                        <?php else: ?>
...
<?php echo $__env->make('user.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MSS\mss-project\resources\views/user/partials/preview_research.blade.php ENDPATH**/ ?>