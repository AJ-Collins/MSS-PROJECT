    ...
    <div class="bg-white shadow overflow-hidden">
        <div class="px-4 py-5 sm:px-6">
            ...
            <div class="mt-4 flex space-x-4">
                <a href="/storage/<?php echo e($submission->pdf__path); ?>" target="_blank" 
                ...
                <a href="/download/<?php echo e($submission->serial_number); ?>" 
                   class="flex items-center text-blue-600 hover:text-blue-800">
                    <svg class="mr-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="border-t border-gray-200">
            <div class="aspect-w-16 aspect-h-9 h-[600px]">
                <iframe src="/storage/<?php echo e($submission->pdf_path); ?>" class="w-full h-full"></iframe>
            </div>
        </div>
        <?php endif; ?>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MSS\mss-project\resources\views/admin/partials/details.blade.php ENDPATH**/ ?>