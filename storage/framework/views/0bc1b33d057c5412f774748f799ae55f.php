...
<div class="max-w-4xl mx-auto">
    <div class="bg-white shadow-lg overflow-hidden">
        ...
        <form id="authorForm" method="POST" action="<?php echo e(route('submit.step1')); ?>" class="p-8" novalidate>
            <?php echo csrf_field(); ?>
...
async function saveDraft(currentStep) {
    try {
        ...
        // Send request
        const response = await fetch('<?php echo e(route("user.saveDraft")); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('user.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MSS\email-verification-app\resources\views\user\partials\step1.blade.php ENDPATH**/ ?>