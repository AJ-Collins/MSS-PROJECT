        ...
        <div class="bg-white shadow-xl overflow-hidden">
            ...
            <?php if(isset($assessments) && $assessments->isNotEmpty()): ?>
                            ...
                            <?php $__currentLoopData = $assessments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assessment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap hidden md:table-cell">
                                        <span class="text-sm text-gray-500"><?php echo e($assessment->thematic_score); ?></span>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap hidden md:table-cell">
                                        <span class="text-sm text-gray-500"><?php echo e($assessment->title_score); ?></span>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap hidden lg:table-cell">
                                        <span class="text-sm text-gray-500"><?php echo e($assessment->objectives_score); ?></span>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap hidden lg:table-cell">
                                        <span class="text-sm text-gray-500"><?php echo e($assessment->methodology_score); ?></span>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap hidden lg:table-cell">
                                        <span class="text-sm text-gray-500"><?php echo e($assessment->output_score); ?></span>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <?php if($assessment->correction_type): ?>
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                                <?php echo e($assessment->correction_type == 'minor' ? 'bg-yellow-100 text-yellow-800' : 
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap hidden md:table-cell text-sm text-gray-500">
                                        <?php echo e(Str::limit($assessment->general_comments, 20, '...') ?: 'No comments'); ?>

                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <?php echo e($assessment->total_score ?: 'No score'); ?>
                ...
                <div class="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
                    <div class="flex-1 flex justify-between sm:hidden">
                        ...
                        <?php echo e($assessments->links('vendor.pagination.simple-tailwind')); ?>
                    ...
                    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                        ...
                        <div>
                            <?php echo e($assessments->links('vendor.pagination.tailwind')); ?>
            ...
            <div class="overflow-x-auto">
                    <table class="w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__currentLoopData = $proposalAssessments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proposalAssessment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900">
                                            <?php echo e($proposalAssessment->reviewer ? $proposalAssessment->reviewer->first_name . ' ' . $proposalAssessment->reviewer->last_name : 'N/A'); ?>

                                        </div>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap hidden md:table-cell">
                                        <span class="text-sm text-gray-500"><?php echo e($proposalAssessment->thematic_score); ?></span>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap hidden md:table-cell">
                                        <span class="text-sm text-gray-500"><?php echo e($proposalAssessment->title_score); ?></span>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap hidden lg:table-cell">
                                        <span class="text-sm text-gray-500"><?php echo e($proposalAssessment->objectives_score); ?></span>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap hidden lg:table-cell">
                                        <span class="text-sm text-gray-500"><?php echo e($proposalAssessment->methodology_score); ?></span>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap hidden lg:table-cell">
                                        <span class="text-sm text-gray-500"><?php echo e($proposalAssessment->output_score); ?></span>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <?php if($proposalAssessment->correction_type): ?>
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                                <?php echo e($proposalAssessment->correction_type == 'minor' ? 'bg-yellow-100 text-yellow-800' : 
                                                   ($proposalAssessment->correction_type == 'major' ? 'bg-red-100 text-red-800' : 'bg-gray-100 text-gray-800')); ?>">
                                                <?php echo e(ucfirst($proposalAssessment->correction_type)); ?>
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap hidden md:table-cell text-sm text-gray-500">
                                        <?php echo e(Str::limit($proposalAssessment->general_comments, 20, '...') ?: 'No comments'); ?>

                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <?php echo e($proposalAssessment->total_score ?: 'No score'); ?>

                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap text-center">
                                        <a href="<?php echo e(route('assessments.proposal.download-pdf', $proposalAssessment->abstract_submission_id)); ?>" 
                                           class="text-blue-600 hover:text-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-full p-2 transition duration-200">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                                                    d="M12 4v12m0 0l-4-4m4 4l4-4m0 8H8m8 0h4"/>
                ...
                <div class="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
                    <div class="flex-1 flex justify-between sm:hidden">
                        ...
                        <?php echo e($proposalAssessments->links('vendor.pagination.simple-tailwind')); ?>
                    ...
                    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                        ...
                        <div>
                            <?php echo e($proposalAssessments->links('vendor.pagination.tailwind')); ?>
