...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    ...
                    <h2 class="ml-4 text-2xl font-bold text-indigo-600 flex items-center">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false"
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button type="submit" 
                                        class="flex w-full items-center px-4 py-2 text-sm text-red-700 hover:bg-red-50 transition duration-150">
    ...
    <div class="flex pt-16 h-screen">
        <!-- Enhanced Sidebar -->
        <div class="fixed inset-y-0 left-0 z-30 w-64 transition-all duration-300 transform bg-indigo-600"
            ...
            <nav class="mt-10">
                <a class="flex items-center px-6 py-3 text-white hover:bg-indigo-700 transition duration-150"
                   href="#">
                ...
                <a class="flex items-center px-6 py-3 mt-1 text-white hover:bg-indigo-700 transition duration-150"
                   href="#">
                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-700">1,482</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-700">642</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-700">276</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-700">$45,678</p>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="relative flex items-start space-x-3">
                                        ...
                                        <div class="min-w-0 flex-1">
                                            <div>
                                                ...
                                                <p class="mt-0.5 text-sm text-gray-500">Created a new order #12345</p>
                                            </div>
                                            <div class="mt-2 text-sm text-gray-700">
                                                <p>Order total: $234.00</p>
                                            </div>
                                        </div>
                                        <div class="flex-shrink-0 self-center">
                                            <span class="text-sm text-gray-500">5m ago</span>
                                        </div>
                                    </div>
                                </li>
