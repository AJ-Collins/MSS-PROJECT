    ...
    <form 
        ...
        <div id="authorsContainer" class="space-y-8">
            ...
            <div class="mb-8">
                ...
                <div id="file-preview" class="{{ session('abstract.pdf_document_path') ? '' : 'hidden' }} mt-4 p-4 bg-gray-50 rounded-md">
                    <p class="text-sm text-gray-600">
                        Selected file: 
                        <span id="file-name" class="font-medium">
                            {{ basename(session('abstract.pdf_document_path')) ?? 'No file selected' }}
                        </span>
                    </p>
