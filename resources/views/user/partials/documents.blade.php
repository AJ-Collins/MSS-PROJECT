                    ...
                    @foreach ($submissions as $submission)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-4 text-center">
                                <span class="px-3 py-1 text-xs font-medium text-yellow-800 bg-yellow-100 rounded-full">{{ $submission->final_status ?? 'pending' }}</span>
                            </td>
                            <td class="px-4 py-4">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                @foreach ($researchSubmissions as $researchSubmission)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-4 text-center">
                            <span class="px-3 py-1 text-xs font-medium text-yellow-800 bg-yellow-100 rounded-full">{{ $researchSubmission->final_status ?? 'pending' }}</span>
                        </td>
                        <td class="px-4 py-4">
                            <div class="flex flex-col items-center space-y-2">
                                <button onclick="openModal('abstract-preview-modal-{{ $researchSubmission->id }}')" class="text-xs text-blue-600 hover:text-blue-800">View Abstract</button>
                    ...
                    <div id="abstract-preview-modal-{{ $researchSubmission->id }}" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50">
                        <div class="bg-white shadow-xl w-full max-w-4xl flex flex-col" style="height: 95vh;">
                            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                                ...
                                <button onclick="closeModal('abstract-preview-modal-{{ $researchSubmission->id }}')" class="text-gray-400 hover:text-gray-500">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="mt-4">
                                        <p class="text-sm text-gray-700"><strong>Status:</strong>
                                            <span class="@if($researchSubmission->final_status === 'Approved') text-green-600 font-semibold 
                                                       @elseif($researchSubmission->final_status === 'Rejected') text-red-600 font-semibold 
                                                       @else text-yellow-600 font-semibold @endif">
                            ...
                            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end">
                                <button onclick="closeModal('abstract-preview-modal-{{ $researchSubmission->id }}')" 
