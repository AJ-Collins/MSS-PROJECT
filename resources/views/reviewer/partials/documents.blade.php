...
<div x-data="{ activeTab: 'abstracts', searchQuery: '', showFilters: false, statusFilter: 'all' }">
    ...
    Assess
                                ...
                                <button class="group relative p-2 text-gray-600 hover:text-green-600 rounded-full hover:bg-green-50">
                                    ...
                                    <span class="absolute bottom-full left-1/2 transform -translate-x-1/2 px-2 py-1 text-xs text-white bg-gray-900 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200">Approve</span>
                                </button>
