                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-center text-sm text-gray-700">
                                <div class="flex justify-center p-2">
                                    <a href="{{ route('reviewer.abstract.assessment', ['serial_number' => $submission->serial_number]) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition-all">
