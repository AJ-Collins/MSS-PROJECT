                ...
                <tbody>
                    @forelse ($submissions as $submission)
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <a href="{{ route('abstract.asessment.download', ['serial_number' => $submission->serial_number]) }}" 
            ...
            <tbody>
                @forelse ($researchSubmissions as $researchSubmission)
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-center text-sm text-gray-700">
                            <a href="{{ route('abstract.proposalAssessment.download', ['serial_number' => $researchSubmission->serial_number]) }}" 
                                class="flex items-center text-blue-600 hover:text-blue-800 w-full sm:w-auto">
                                    <svg class="mr-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                                    </svg>
